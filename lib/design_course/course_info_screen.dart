...
class CourseInfoScreen extends StatefulWidget {
  final AsyncSnapshot<CourseDetailsList> snapshot;
  final int index;

  CourseInfoScreen(this.snapshot, this.index);
...
//                height: 200.0,
//                width: 200.0,
//                child: MarqueeWidget(child: Text('fsfsfhjsf')),
////                child: Marquee(
////                  text: UtilsData.kAppName,
