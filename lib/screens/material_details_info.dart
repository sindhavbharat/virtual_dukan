...
class MaterialDetailsInfo extends StatefulWidget {
  final int id;
  final double discount;
  final String type;

  MaterialDetailsInfo({this.id, this.discount, this.type});

  @override
  _MaterialDetailsInfoState createState() => _MaterialDetailsInfoState();
}

class _MaterialDetailsInfoState extends State<MaterialDetailsInfo>
...
//    _progressDialog.show();
    ...
    print('material details info ${jsonDecode(response.body)}');
//      _progressDialog.hide();
  ...
  Future<void> _addToCartItem({int id, BuildContext context}) async {
    ...
    SharedPreferences preferences = await SharedPreferences.getInstance();
    print('token ${preferences.getString(UtilsData.kToken)}');
    print('request ${UtilsData.kBaseUrl + UtilsData.kAddCartMethod +
        id.toString()}');
