...
import 'package:virtual_dukan/design_course/models/institutes_details_model.dart';
import 'package:virtual_dukan/design_course/models/product_list_model.dart';
...
class InstitutesDetailsInfo extends StatefulWidget {
  final int id;
  ...
  @override
  _InstitutesDetailsInfoState createState() => _InstitutesDetailsInfoState();
}

class _InstitutesDetailsInfoState extends State<InstitutesDetailsInfo>
  ...
  double opacity2 = 0.0;
  double opacity3 = 0.0;
  Future<ProductListModel> _future;
  bool isShowData;
...
//    }
  ...
  Future<ProductListModel> getData() async {
...
//    _progressDialog.show();
    try {
      ...
      final response = await http.get(
        UtilsData.kBaseUrl + UtilsData.kGetProductListMethod +
            '/${widget.id}',
