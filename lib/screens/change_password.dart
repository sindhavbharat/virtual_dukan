...
class _ChangeDetailsState extends State<ChangeDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          UtilsData.kAppBar(context: context, title: UtilsData.kChangePassword),
          Expanded(
            child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                child: Center(
                                  child: Text(UtilsData.kChangePassword,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontFamily:
  ...
  Future<void> _finalRequest({String otp, String password}) async {
    ...
    final http.Response response = await http.post(
      UtilsData.kBaseUrl + UtilsData.kChangePasswordMethod,
