...
class EnglishMediumListView extends StatefulWidget {
  @override
  _EnglishMediumListViewState createState() => _EnglishMediumListViewState();
}

class _EnglishMediumListViewState extends State<EnglishMediumListView>
    with TickerProviderStateMixin {
  AnimationController animationController;
  Future<EnglishMediumListModel> _future;
  ...
  Future<EnglishMediumListModel> getData() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    print('token ${preferences.getString(UtilsData.kToken)}');
    final response = await http.get(
      UtilsData.kBaseUrl + UtilsData.kGetEnglishMediumListMethod,
    ...
    if (response.statusCode == 200) {
      return EnglishMediumListModel.fromJson(jsonDecode(response.body));
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: FutureBuilder<EnglishMediumListModel>(
          future: _future,
          builder: (BuildContext context,
              AsyncSnapshot<EnglishMediumListModel> snapshot) {
            if (!snapshot.hasData) {
