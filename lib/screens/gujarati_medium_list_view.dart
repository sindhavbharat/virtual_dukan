...
import 'package:virtual_dukan/design_course/models/english_medium_list_model.dart';
import 'package:virtual_dukan/design_course/models/gujarati_medium_list_model.dart';
...
class GujaratiMediumListView extends StatefulWidget {
  @override
  _GujaratiMediumListViewState createState() => _GujaratiMediumListViewState();
}

class _GujaratiMediumListViewState extends State<GujaratiMediumListView>
    with TickerProviderStateMixin {
  AnimationController animationController;
  Future<GujaratiMediumListModel> _future;
  ...
  Future<GujaratiMediumListModel> getData() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    print('token ${preferences.getString(UtilsData.kToken)}');
    final response = await http.get(
      UtilsData.kBaseUrl + UtilsData.kGetGujaratiMediumListMethod,
    ...
    if (response.statusCode == 200) {
      return GujaratiMediumListModel.fromJson(jsonDecode(response.body));
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: FutureBuilder<GujaratiMediumListModel>(
          future: _future,
          builder: (BuildContext context,
              AsyncSnapshot<GujaratiMediumListModel> snapshot) {
            if (!snapshot.hasData) {
