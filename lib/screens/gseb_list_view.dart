...
class GSEBListView extends StatefulWidget {
  @override
  _GSEBListViewState createState() => _GSEBListViewState();
}

class _GSEBListViewState extends State<GSEBListView>
    with TickerProviderStateMixin {
  AnimationController animationController;
  Future<GSEBListModel> _future;
  ...
  Future<GSEBListModel> getData() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    print('token ${preferences.getString(UtilsData.kToken)}');
    final response = await http.get(
      UtilsData.kBaseUrl + UtilsData.kGetGSEBListMethod,
    ...
    if (response.statusCode == 200) {
      return GSEBListModel.fromJson(jsonDecode(response.body));
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: FutureBuilder<GSEBListModel>(
          future: _future,
          builder: (BuildContext context,
              AsyncSnapshot<GSEBListModel> snapshot) {
            if (!snapshot.hasData) {
