...
//      _progressDialog.hide();
  ...
  Widget getMainListViewUI() {
    return Padding(
      ...
      child: FutureBuilder<MaterialDetailList>(
        future: getData(),
        builder:
            (BuildContext context, AsyncSnapshot<MaterialDetailList> snapshot) {
          if (!snapshot.hasData) {
            ...
            length = snapshot.data.course.materials.length;
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Text(
                                          snapshot.data.course.materials[index]
                                              .title,
