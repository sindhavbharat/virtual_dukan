...
import 'package:virtual_dukan/design_course/models/cbse_product_list_model.dart';
...
class CBSEListView extends StatefulWidget {
  @override
  _CBSEListViewState createState() => _CBSEListViewState();
}

class _CBSEListViewState extends State<CBSEListView>
    with TickerProviderStateMixin {
  AnimationController animationController;
  Future<CBSEListModel> _future;
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: FutureBuilder<CBSEListModel>(
          future: _future,
          builder: (BuildContext context,
              AsyncSnapshot<CBSEListModel> snapshot) {
            if (!snapshot.hasData) {
